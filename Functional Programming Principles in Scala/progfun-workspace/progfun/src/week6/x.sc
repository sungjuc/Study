...
object x {
  val in = Source.fromFile("/Users/scho/workspace/github/Study/Functional Programming Principles in Scala/progfun-workspace/progfun/src/week6/linuxwords.txt")
