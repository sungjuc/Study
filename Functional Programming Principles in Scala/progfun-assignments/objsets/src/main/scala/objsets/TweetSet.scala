  ...
  def descendingByRetweet: TweetList = {
    this match {
      ...
      case _ => {
        ...
        val list = this.remove(popular).descendingByRetweet
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    right match {
      case _: Empty => midMost
      case _ => {
        val rightMost = right.mostRetweeted
        if (midMost.retweets > rightMost.retweets) midMost else rightMost
      }
    }
  }
